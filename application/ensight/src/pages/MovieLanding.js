      ...
      <div className="MovieLandingContent">
        ...
        <div className="MovieLandingInformation">
          ...
          <div className="MovieLandingSypnosis">
            <h3>
              This will be the Movie's Sypnosis. It will give a brief
              description of what the movie is about but not enough information
              to spoil the movie. It should be short and about 3-4 sentences.
